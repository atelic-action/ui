...
- **Layout by kind:** `src/chrome/`, `src/email/`, `src/tokens/`, `src/hooks/`, `src/styles/`, `src/lib/` for internal helpers, `src/types.ts`, with `src/components/` to come. Tests live in `tst/`.
