...
- **Acronyms stay fully capitalized** in every name the package mints: components, props, types, variables, file names, and CSS classes (`StickyCTABar`, `primaryCTA`, `.nav-CTA`). Prefer names that do not start with one.
